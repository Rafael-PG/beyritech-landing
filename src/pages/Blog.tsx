...
import { Calendar, Clock, ArrowRight, Box, Sparkles } from "lucide-react";
...
export default function Blog() {
  ...
  const modelos: string[] = ["todos", ...Array.from(new Set<string>(posts.map((p) => p.modelo)))];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-gold-500/10 border border-gold-500/20 text-gold-500 text-xs font-mono uppercase tracking-widest mb-3">
            ...
            Ingeniería & Soluciones Modulares
          </div>
          ...
          <p className="text-jet-300 mt-4 max-w-2xl font-light leading-relaxed text-base">
            Documentación técnica sobre módulos prefabricados, requisitos de terreno,
            comparativas de aislamiento y buenas prácticas de despliegue en campo.
          </p>
        </div>
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-20 text-jet-300 font-light border border-jet-800/80 rounded-xl bg-jet-900/40 p-12">
            <Box className="w-12 h-12 text-jet-600 mx-auto mb-4" />
            <p className="text-base text-jet-300">No hay artículos publicados en esta categoría aún.</p>
          </div>
        )}
              ...
              <div>
                ...
                <div className="h-56 sm:h-64 w-full relative overflow-hidden bg-jet-950">
                  ...
                  {post.image ? (
                    ...
                    /* Fondo técnico sofisticado si no hay imagen */
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-3 text-xs font-mono text-jet-400 mb-3">
                    ...
                    <span className="flex items-center gap-1">
                      ...
                      {new Date(post.date).toLocaleDateString("es-PE", { year: "numeric", month: "short", day: "numeric" })}
                    </span>
                  </div>
