    ...
    <section id="faq" className="py-24 bg-jet-900 text-white relative [content-visibility:auto] [contain-intrinsic-size:600px]">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div id="testimonials" className="mb-24">
          ...
          <div className="max-w-4xl mx-auto bg-jet-950 border border-jet-800 rounded-lg p-8 sm:p-12 relative shadow-2xl">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-jet-950 border border-jet-800 rounded overflow-hidden transition-all duration-300"
                >
                  <button
                  ...
                  <div
                    className={`transition-all duration-300 overflow-hidden ${
                      isOpen ? "max-h-96 border-t border-jet-900" : "max-h-0"
                    }`}
                  >
                    <div className="p-6 text-sm text-jet-300 font-light leading-relaxed bg-jet-950/40 flex gap-3">
