...
export const faqs: FAQItem[] = [
  ...
  {
    category: "Normativa",
    question: "¿Cumplen con normativas sanitarias y de habitabilidad?",
    answer: "Cumplimos con normativas de habitabilidad, espacios mínimos y aislación acústica, así como con requisitos higiénico-sanitarios aplicables a clínicas, casinos y laboratorios."
  },
  {
